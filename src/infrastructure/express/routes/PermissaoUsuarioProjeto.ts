...
const PermissaoUsuarioProjeto = Router()
 ...
 *     tags: [Permissão de usuário em Projeto]
 */
PermissaoUsuarioProjeto.get('/', authMiddleware, (req, res, next) =>
 ...
 *     tags: [Permissão de usuário em Projeto]
 */
PermissaoUsuarioProjeto.post('/', authMiddleware, (req, res, next) =>
 ...
 *     tags: [Permissão de usuário em Projeto]
 */
PermissaoUsuarioProjeto.delete('/:id', authMiddleware, (req, res, next) =>
 ...
 *     tags: [Permissão de usuário em Projeto]
 */
PermissaoUsuarioProjeto.patch('/:id', authMiddleware, (req, res, next) =>
  projetoController.atualizar(req, res, next)
)

export default PermissaoUsuarioProjeto
